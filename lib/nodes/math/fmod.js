...
var FMod = /*#__PURE__*/function (_Node) {
  ...
  function FMod() {
    ...
    _this.inputs = [new _socket.InputSocket("Val1", _assertThisInitialized(_this), _type.Types.NUMBER, 0), new _socket.InputSocket("Val2", _assertThisInitialized(_this), _type.Types.NUMBER, 0)];
