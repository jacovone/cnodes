...
var FTofixed = /*#__PURE__*/function (_Node) {
  ...
  function FTofixed() {
    ...
    _this.inputs = [new _socket.InputSocket("Val", _assertThisInitialized(_this), _type.Types.NUMBER, 0), new _socket.InputSocket("Digits", _assertThisInitialized(_this), _type.Types.NUMBER, 0)];
