 ...
 */
class FAnd extends _node.Node {
  // Provide a node instance

  /**
   * Construct a new FAnd node
   */
  constructor() {
    super("FAnd"); // The node is pure functional
...
_defineProperty(FAnd, "instance", () => new FAnd());