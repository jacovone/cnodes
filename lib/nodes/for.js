...
var For = /*#__PURE__*/function (_Node) {
  ...
  function For() {
    ...
    _this.inputs = [new _socket.InputSocket("From", _assertThisInitialized(_this), _type.Types.NUMBER, 0), new _socket.InputSocket("To", _assertThisInitialized(_this), _type.Types.NUMBER, 0)];
  ...
  _createClass(For, [{
    ...
    value: function () {
      var _process = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
        var prevCurrentNode, index, _this$next$peer;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 7:
                ...
                if (!(((_this$next$peer = this.next("Do").peer) === null || _this$next$peer === void 0 ? void 0 : _this$next$peer.node) !== null)) {
                  _context.next = 12;
                  break;
                }
