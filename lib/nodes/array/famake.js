...
var FAMake = /*#__PURE__*/function (_Node) {
  ...
  function FAMake() {
    ...
    _this.inputs = [new _socket.InputSocket("0", _assertThisInitialized(_this), _type.Types.ANY, ""), new _socket.InputSocket("1", _assertThisInitialized(_this), _type.Types.ANY, "")];
    _this.outputs = [new _socket.OutputSocket("Val", _assertThisInitialized(_this), _type.Types.ARRAY, [], false)];
    _this.nexts = [];
    _this.prev = null;
    return _this;
  }
