...
var FAGet = /*#__PURE__*/function (_Node) {
  ...
  function FAGet() {
    ...
    _this.inputs = [new _socket.InputSocket("Array", _assertThisInitialized(_this), _type.Types.ARRAY, 0), new _socket.InputSocket("Index", _assertThisInitialized(_this), _type.Types.NUMBER, 0)];
