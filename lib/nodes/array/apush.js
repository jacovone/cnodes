...
var APush = /*#__PURE__*/function (_Node) {
  ...
  function APush() {
    ...
    _this.inputs = [new _socket.InputSocket("Array", _assertThisInitialized(_this), _type.Types.ARRAY), new _socket.InputSocket("Val", _assertThisInitialized(_this), _type.Types.ANY)];
