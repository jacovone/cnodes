...
var FConcat = /*#__PURE__*/function (_Node) {
  ...
  function FConcat() {
    ...
    _this.inputs = [new _socket.InputSocket("0", _assertThisInitialized(_this), _type.Types.STRING, ""), new _socket.InputSocket("1", _assertThisInitialized(_this), _type.Types.STRING, "")];
    _this.outputs = [new _socket.OutputSocket("Val", _assertThisInitialized(_this), _type.Types.STRING, "", false)];
    _this.nexts = [];
    _this.prev = null;
    return _this;
  }
