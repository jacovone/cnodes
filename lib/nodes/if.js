...
var If = /*#__PURE__*/function (_Node) {
  ...
  function If() {
    ...
    _this.inputs = [new _socket.InputSocket("Condition", _assertThisInitialized(_this), _type.Types.BOOLEAN, false)];
    _this.outputs = [];
    _this.nexts = [new _socket.NextSocket("Then", _assertThisInitialized(_this)), new _socket.NextSocket("Else", _assertThisInitialized(_this))];
